      ...
      >
        <SwiperSlide className="bg-[url(/images/slide/slide-1.png)] bg-no-repeat  bg-right">
          ...
          <div className="absolute inset-0 flex flex-col justify-center pl-12 md:p-16 gap-2 md:gap-4 text-slate-300">
            <h1 className="text-3xl md:text-5xl uppercase font-extrabold text-yellow-600">Free Arcade Games</h1>
            <p className="text-lg md:text-xl">Play Retro Games for free.</p>
            <p className="text-sm md:text-md hidden md:block lg:max-w-[400px]">Relive The Classic Retro Games and Enjoy them for free. Start Playing now.</p>
            <a href="/" className="bg-yellow-600 hover:bg-yellow-500 font-bold text-lg transition-all ease-in text-black rounded-lg px-3 py-1 w-max">Play Now</a>
          </div>
        </SwiperSlide>
